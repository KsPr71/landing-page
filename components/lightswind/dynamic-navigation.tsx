  ...
  return (
    <nav
      ...
      style={{
        ...
        boxShadow:
          glowIntensity > 0
            ? `0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1), 0 0 ${glowIntensity}px rgba(255,255,255,0.3)`
            : undefined,
      }}
    >
      ...
      <div
        ...
        className={cn(
          ...
          duration-300 [transition-timing-function:cubic-bezier(0.25,1,0.5,1)] z-0`,
